    ...
    <div className='navbar bg-base-100'>
      <div className='navbar-start'>
        ...
        <a className='flex items-center btn btn-ghost text-2xl font-bold' onClick={() => window.location.href = '/'}>
          <img src="https://res.cloudinary.com/df5utoo6u/image/upload/v1758632549/main_logo_ftyyse.jpg" alt='ReeFood Logo' className='w-8 h-8 hidden' />
          <h3 className='font-bold'>BizPilot</h3> {/* Go On Brand */}
        </a>
      </div>
      ...
      <div className='navbar-end'>
        ...
        <img
          ...
          src="https://res.cloudinary.com/df5utoo6u/image/upload/v1758632549/main_logo_ftyyse.jpg"
